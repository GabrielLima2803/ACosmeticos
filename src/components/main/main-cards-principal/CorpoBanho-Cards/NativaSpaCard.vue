<script setup>
import { nativaSpa } from '@/_data/corpoebanho.js'
</script>
...
<template>
    <div class="card-cosmeticos">
        <div class="card-cosmeticos">
            <div v-for="(nativaSpas) in nativaSpa" :key="nativaSpas.id" class="card-margin flexCard">
                ...
                <div class="tamanho-card">
                    <img :src="nativaSpas.img" class="capa-img" />
                </div>

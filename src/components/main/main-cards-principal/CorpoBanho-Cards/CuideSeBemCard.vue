<script setup>
import { cuideSeBem } from '@/_data/corpoebanho.js'
</script>
...
<template>
    <div class="card-cosmeticos">
        <div class="card-cosmeticos">
            <div v-for="(cuideSeBems) in cuideSeBem" :key="cuideSeBems.id" class="card-margin flexCard">
                ...
                <div class="tamanho-card">
                    <img :src="cuideSeBems.img" class="capa-img" />
                </div>

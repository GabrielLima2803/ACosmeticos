<script setup>
import { malbecCorpo } from '@/_data/corpoebanho.js'
</script>
...
<template>
    <div class="card-cosmeticos">
        <div class="card-cosmeticos">
            <div v-for="(malbecCorpos) in malbecCorpo" :key="malbecCorpos.id" class="card-margin flexCard">
                ...
                <div class="tamanho-card">
                    <img :src="malbecCorpos.img" class="capa-img" />
                </div>

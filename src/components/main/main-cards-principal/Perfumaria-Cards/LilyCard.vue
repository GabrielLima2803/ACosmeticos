<script setup>
import { lily } from '@/_data/CardPerfumaria.js'
</script>
...
<template>
    <div class="card-cosmeticos">
        <div class="card-cosmeticos">
            <div v-for="(lilys) in lily" :key="lilys.id" class="card-margin flexCard">
                ...
                <div class="tamanho-card">
                    <img :src="lilys.img" @mouseover="lilys.img = lilys.hover" 
                        @mouseleave="lilys.img = lilys.original" class="capa-img" />
                </div>

<script setup>
import { coffe } from '@/_data/CardPerfumaria.js'
</script>
...
<template>
    <div class="card-cosmeticos">
        <div class="card-cosmeticos">
            <div v-for="(coffes) in coffe" :key="coffes.id" class="card-margin flexCard">
                ...
                <div class="tamanho-card">
                    <img :src="coffes.img" @mouseover="coffes.img = coffes.hover"
                        @mouseleave="coffes.img = coffes.original" class="capa-img" />
                </div>

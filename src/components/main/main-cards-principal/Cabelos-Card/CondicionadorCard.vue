<script setup>
import { condicionador } from '@/_data/cabelos.js'
</script>
...
<template>
    <div class="card-cosmeticos">
        <div class="card-cosmeticos">
            <div v-for="(condicionador) in shampoo" :key="condicionador.id" class="card-margin flexCard">
                ...
                <div class="tamanho-card">
                    <img :src="condicionador.img" class="capa-img" />
                </div>

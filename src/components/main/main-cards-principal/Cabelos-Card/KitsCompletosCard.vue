<script setup>
import { kitCompleto } from '@/_data/cabelos.js'
</script>
...
<template>
    <div class="card-cosmeticos">
        <div class="card-cosmeticos">
            <div v-for="(kitsCompletos) in kitCompleto" :key="kitsCompletos.id" class="card-margin flexCard">
                ...
                <div class="tamanho-card">
                    <img :src="kitsCompletos.img" class="capa-img" />
                </div>

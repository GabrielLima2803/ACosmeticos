<script setup>
import { cremePentear } from '@/_data/cabelos.js'
</script>
...
<template>
    <div class="card-cosmeticos">
        <div class="card-cosmeticos">
            <div v-for="(cremedePentear) in cremePentear" :key="cremedePentear.id" class="card-margin flexCard">
                ...
                <div class="tamanho-card">
                    <img :src="cremedePentear.img" class="capa-img" />
                </div>
                ...
                <p class="descricao-Cos">
                    {{ cremedePentear.descricao }}
                </p>
                <p class="preco-Cos">
                    {{ cremedePentear.preco }}
                </p>

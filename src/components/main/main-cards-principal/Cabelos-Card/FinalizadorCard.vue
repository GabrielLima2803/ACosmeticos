<script setup>
import { finalizador } from '@/_data/cabelos.js'
</script>
...
<template>
    <div class="card-cosmeticos">
        <div class="card-cosmeticos">
            <div v-for="(finalizadores) in finalizador" :key="finalizadores.id" class="card-margin flexCard">
                ...
                <div class="tamanho-card">
                    <img :src="finalizadores.img" class="capa-img" />
                </div>

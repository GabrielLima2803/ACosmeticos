...
const condicionador = [
    {
      id: 1,
      nome:'Condicionador Cuide-se Bem Feira',
  ...
  const cremePentear = [
    ...
    {
      id: 4,
      nome:'Creme sem Enxágue Nativa SPA',
  ...
  const finalizador = [
    {
      ...
      descricao:'CC Cream Match Liga dos Coloridos 50ml',
      preco:'R$ 44,90',
    ...
    {
      id: 4,
      nome:'Sérum Capilar Pós-Química Match',
  ...
  const kitCompleto = [
    ...
    },
    {
      ...
      descricao:'Shampoo + Condicionador + Sabonete',
      preco:'R$ 45,90',
